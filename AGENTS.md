...
- After intake, stop only for the exact rough-cut and color approvals required by `create-social-reel`, unless a later user-requested change invalidates an approval or introduces a genuinely new blocker.
